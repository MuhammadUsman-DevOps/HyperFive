                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 order-card">
                            <div class="card rounded border-gray-300 border-1 border-dashed px-7 py-3 mb-6">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="">
                                        <!--begin::Title-->
                                        <span class="text-gray-800 text-hover-primary fw-bold mb-5 fs-3"> #Service name  </span>
                                ...
                                <span
                                    class="text-black">date </span>
                                    <span
                                        class="text-black">date</span>
                                </div>

                                <div class="mt-2 d-flex justify-content-between">
                                    <span class="text-black">Channel</span>
