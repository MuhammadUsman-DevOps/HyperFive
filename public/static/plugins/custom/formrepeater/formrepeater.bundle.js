...
!function (t) {
    ...
    var e = function (t, e) {
        ...
        return r.getType = function () {
            ...
            var a = r.get();
            e.equalTo(a, n) || r.publish("change", {e: t, domElement: i}), n = a
        }, r
    }, n = function (t, n) {
        var r = e(t, n);
        ...
        var n = {}, r = e.$, g = e.constructorOverride || {
            button: i,
            text: m,
            url: y,
            email: u,
            ...
            var a = [], u = isObject(i) ? i : r.find(i);
            isObject(i) ? n[u.attr("name")] = g[e]({$: u}) : (u.each((function () {
    ...
    return t = t || {}, $(this).each((function () {
        var n = $(this), r = t.show || function () {
                $(this).show()
            }, i = t.hide || function (t) {
                t()
            }, a = n.find("[data-repeater-list]").first(), u = function (t, e) {
        ...
        var s = function () {
            ...
            t.each((function (t) {
                ...
                r.data("item-name", e + "[" + t + "]"), u(r.find("[name]"), n).each((function () {
                    var i = $(this), a = i.attr("name").match(/\[[^\]]+\]/g),
