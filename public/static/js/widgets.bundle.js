...
var KTSlidersWidget1 = function () {
    var e = function (e, a) {
        ...
        if (t && !t.classList.contains("initialized")) {
            var l = parseInt(KTUtil.css(t, "height")), o = KTUtil.getCssVariableValue("--bs-primary"),
                r = KTUtil.getCssVariableValue("--bs-light-primary");
            new ApexCharts(t, {
                series: [a],
                chart: {fontFamily: "inherit", height: l, type: "radialBar", sparkline: {enabled: !0}},
                plotOptions: {
                    radialBar: {
...
var KTSlidersWidget3 = function () {
    var e = function (e, a, t) {
        ...
        if (l && !l.classList.contains("initialized")) {
            var o = parseInt(KTUtil.css(l, "height")), r = KTUtil.getCssVariableValue("--bs-gray-500"),
                i = KTUtil.getCssVariableValue("--bs-border-dashed-color"), s = KTUtil.getCssVariableValue("--bs-" + a);
            new ApexCharts(l, {
                series: [{name: "Lessons", data: t}],
                ...
                xaxis: {
                    ...
                    axisTicks: {show: !1},
                    tickAmount: 6,
                    labels: {rotate: 0, rotateAlways: !0, style: {colors: r, fontSize: "12px"}},
                    crosshairs: {position: "front", stroke: {color: s, width: 1, dashArray: 3}},
                    tooltip: {enabled: !0, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}
                },
                yaxis: {tickAmount: 4, max: 24, min: 10, labels: {style: {colors: r, fontSize: "12px"}}},
                states: {
                ...
                colors: [s],
                grid: {borderColor: i, strokeDashArray: 4, yaxis: {lines: {show: !0}}},
                markers: {strokeColor: s, strokeWidth: 3}
...
var KTTablesWidget14 = function () {
    var e = function (e, a) {
        var t = document.querySelector(e);
        if (t) {
            var l = parseInt(KTUtil.css(t, "height")), o = t.getAttribute("data-kt-chart-color"),
                r = KTUtil.getCssVariableValue("--bs-gray-800"), i = KTUtil.getCssVariableValue("--bs-gray-300"),
                s = KTUtil.getCssVariableValue("--bs-" + o), n = KTUtil.getCssVariableValue("--bs-white"),
                m = new ApexCharts(t, {
                    ...
                    stroke: {curve: "smooth", show: !0, width: 2, colors: [s]},
                    xaxis: {
                        categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"],
                        axisBorder: {show: !1},
                        axisTicks: {show: !1},
                        labels: {show: !1, style: {colors: r, fontSize: "12px"}},
                        crosshairs: {show: !1, position: "front", stroke: {color: i, width: 1, dashArray: 3}},
                        tooltip: {enabled: !1}
                    },
                    ...
                    tooltip: {enabled: !1},
                    colors: [n],
                    markers: {colors: [n], strokeColor: [s], strokeWidth: 3}
                });
            setTimeout((function () {
                m.render()
            }), 200)
...
var KTTablesWidget4 = function () {
    ...
    const l = () => {
        ...
        const e = document.querySelectorAll('[data-kt-table-widget-4="expand_row"]'), a = [3, 1, 3, 1, 2, 1];
        e.forEach(((e, t) => {
            e.addEventListener("click", (l => {
                l.stopImmediatePropagation(), l.preventDefault();
                const r = e.closest("tr"), s = ["isOpen", "border-bottom-0"], n = [];
        ...
        a.forEach(((o, r) => {
            const i = t.cloneNode(!0), s = i.querySelector('[data-kt-table-widget-4="template_image"]'),
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_table_widget_5_table")) && (e.querySelectorAll("tbody tr").forEach((e => {
                const a = e.querySelectorAll("td"), t = moment(a[2].innerHTML, "MMM DD, YYYY").format();
...
var KTFormsWidget1 = {
    init: function () {
        ...
        e = function (e) {
            ...
            var a = document.createElement("span"), t = "";
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    o.mapPolygons.template.setAll({
                        ...
                        toggleKey: "active",
                        interactive: !0
                    }), am5.ColorSet.new(a, {}), o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), o.mapPolygons.template.states.create("hover", {fill: a.interfaceColors.get("primaryButtonHover")}), o.mapPolygons.template.states.create("active", {fill: a.interfaceColors.get("primaryButtonHover")}), t.chartContainer.get("background").events.on("click", (function () {
                        t.goHome()
                    })), t.appear(1e3, 100)
                }))
            }
        ...
        document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach((e => {
            e.addEventListener("shown.bs.tab", (t => {
                "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && (() => {
                    ...
                    var t = Date.now(), l = e.getAttribute("data-kt-timeline-widget-1-image-root"),
                        o = new vis.DataSet([{id: 1, content: "Research", order: 1}, {
                            id: 2,
                    ...
                    if (e.innerHTML) return;
                    var t = Date.now(), l = e.getAttribute("data-kt-timeline-widget-1-image-root"),
                        o = new vis.DataSet([{id: "research", content: "Research", order: 1}, {
                            id: "qa",
                            content: "Phase 2.6 QA",
                            order: 2
            ...
            (() => {
                ...
                var t = Date.now(), l = e.getAttribute("data-kt-timeline-widget-1-image-root"),
                    ...
                    r = new vis.DataSet([{
                        ...
                        onInitialDrawComplete: function () {
                            a();
                            const t = e.closest('[data-kt-timeline-widget-1-blockui="true"]'), l = KTBlockUI.getInstance(t);
                            l.isBlocked() && setTimeout((() => {
                                l.release()
                            }), 1e3)
                        }
...
var KTTimelineWidget2 = {
    init: function () {
        ...
        (e = document.querySelector("#kt_timeline_widget_2_card")) && KTUtil.on(e, '[data-kt-element="checkbox"]', "change", (function (e) {
            var a = this.closest(".form-check"), t = this.closest("tr"),
                l = t.querySelector('[data-kt-element="bullet"]'), o = t.querySelector('[data-kt-element="status"]');
        ...
        document.querySelectorAll('[data-kt-timeline-widget-4="tab"]').forEach((e => {
            e.addEventListener("shown.bs.tab", (t => {
                "#kt_timeline_widget_4_tab_week" === e.getAttribute("href") && (() => {
                    ...
                    if (!e) return;
                    if (e.innerHTML) return;
                    var t = Date.now(), l = e.getAttribute("data-kt-timeline-widget-4-image-root"),
                        o = new vis.DataSet([{id: 1, content: "Research", order: 1}, {
                            id: 2,
                            content: "Phase 2.6 QA",
                            order: 2
            ...
            (() => {
                ...
                var t = Date.now(), l = e.getAttribute("data-kt-timeline-widget-4-image-root"),
                    ...
                    r = new vis.DataSet([{
                        ...
                        onInitialDrawComplete: function () {
                            a();
                            const t = e.closest('[data-kt-timeline-widget-4-blockui="true"]'), l = KTBlockUI.getInstance(t);
                            l.isBlocked() && setTimeout((() => {
                                l.release()
                            }), 1e3)
                        }
        ...
        !function () {
            ...
            if (e) {
                var a = e.hasAttribute("data-kt-negative-color") ? e.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                    t = parseInt(KTUtil.css(e, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--bs-primary"), i = new ApexCharts(e, {
                        series: [{
                            name: "Subscribed",
                        ...
                        chart: {fontFamily: "inherit", type: "bar", stacked: !0, height: t, toolbar: {show: !1}},
    ...
    var e = function (e, a, t, l) {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                ...
                s = {
                    series: [{name: "Achieved Target", data: t}],
                    chart: {fontFamily: "inherit", type: "bar", height: r, toolbar: {show: !1}},
                    plotOptions: {
                        bar: {
                            horizontal: !1,
                            columnWidth: ["22%"],
                    ...
                    grid: {borderColor: i, strokeDashArray: 4, yaxis: {lines: {show: !0}}}
                }, n = new ApexCharts(o, s), m = !1, d = document.querySelector(e);
...
var KTChartsWidget11 = function () {
    var e = function (e, a, t, l) {
        var o = document.querySelector(a), r = parseInt(KTUtil.css(o, "height"));
        if (o) {
            var i = KTUtil.getCssVariableValue("--bs-gray-500"),
                s = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                n = KTUtil.getCssVariableValue("--bs-success"), m = KTUtil.getCssVariableValue("--bs-success"),
                d = new ApexCharts(o, {
                    series: [{name: "Deliveries", data: t}],
                    chart: {fontFamily: "inherit", type: "area", height: r, toolbar: {show: !1}},
                    plotOptions: {},
                    legend: {show: !1},
                    dataLabels: {enabled: !1},
                    fill: {
                    ...
                    xaxis: {
                        ...
                        axisTicks: {show: !1},
                        tickAmount: 5,
                        labels: {rotate: 0, rotateAlways: !0, style: {colors: i, fontSize: "13px"}},
                    ...
                    yaxis: {tickAmount: 4, max: 24, min: 10, labels: {style: {colors: i, fontSize: "13px"}}},
                    states: {
                        normal: {filter: {type: "none", value: 0}},
                        hover: {filter: {type: "none", value: 0}},
                        active: {allowMultipleDataPointsSelection: !1, filter: {type: "none", value: 0}}
                ...
                }), g = !1, c = document.querySelector(e);
        ...
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    t.set("cursor", am5xy.XYCursor.new(a, {behavior: "none"})).lineY.set("visible", !1);
                    ...
                    var r = t.yAxes.push(am5xy.ValueAxis.new(a, {renderer: am5xy.AxisRendererY.new(a, {})}));
                    ...
                    var s = o.makeDataItem({category: "2016", endCategory: "2021"});
        ...
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    t.set("cursor", am5radar.RadarCursor.new(a, {behavior: "zoomX"})).lineY.set("visible", !1);
                    ...
                    var r = t.xAxes.push(am5xy.ValueAxis.new(a, {
                        ...
                        numberFormat: "#'%'",
                        tooltip: am5.Tooltip.new(a, {})
                    })), i = am5radar.AxisRendererRadial.new(a, {minGridDistance: 20});
                    ...
                    var s = t.yAxes.push(am5xy.CategoryAxis.new(a, {categoryField: "category", renderer: i}));
                    s.data.setAll(l);
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    var t = a.container.children.push(am5xy.XYChart.new(a, {
                        ...
                        renderer: am5xy.AxisRendererX.new(a, {minGridDistance: 30}),
                    ...
                    o.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 10,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), o.get("renderer").grid.template.setAll({disabled: !0, strokeOpacity: 0}), o.data.setAll(l);
                    var r = t.yAxes.push(am5xy.ValueAxis.new(a, {renderer: am5xy.AxisRendererY.new(a, {})}));
                    r.get("renderer").grid.template.setAll({
                        stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),
                        strokeWidth: 1,
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    var t = a.container.children.push(am5xy.XYChart.new(a, {
                        ...
                        wheelY: "zoomX",
                        layout: a.verticalLayout
                    })), l = (t.get("colors"), [{country: "US", visits: 725}, {
                        country: "UK",
                        visits: 625
                    ...
                    var i = am5xy.AxisRendererY.new(a, {opposite: !0}),
                        s = t.yAxes.push(am5xy.ValueAxis.new(a, {renderer: i, min: 0, max: 100, strictMinMax: !0}));
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    t.labels.template.setAll({
                        ...
                        startAngle: 180,
                        endAngle: 180
                    }), t.slices.template.setAll({cornerRadius: 5}), t.ticks.template.setAll({forceHidden: !0}), t.data.setAll([{
                        value: 10,
                        category: "One",
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))
                    }, {
...
var KTChartsWidget18 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-900"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = {
...
var KTChartsWidget2 = {
    init: function () {
        ...
        e = document.querySelectorAll(".charts-widget-2"), [].slice.call(e).map((function (e) {
            ...
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"), l = KTUtil.getCssVariableValue("--bs-gray-800"),
                    o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--bs-" + t), i = KTUtil.getCssVariableValue("--bs-light-" + t),
                    s = new ApexCharts(e, {
                        series: [{
                            name: "Overview",
...
var KTChartsWidget20 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-danger"), r = KTUtil.getCssVariableValue("--bs-danger"),
                    i = e.getAttribute("data-kt-chart-info"), s = new ApexCharts(e, {
                        series: [{
                            name: i,
                        ...
                        xaxis: {
                            ...
                            axisTicks: {show: !1},
                            tickAmount: 6,
                            labels: {rotate: 0, rotateAlways: !0, style: {colors: t, fontSize: "12px"}},
    ...
    var e = function (e, a, t, l) {
        ...
        if (o) {
            ...
            var r = {
                ...
                legend: {show: !1},
                fill: {type: "false"}
            }, i = new ApexCharts(o, r), s = !1, n = document.querySelector(e);
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    o.data.setAll(l), o.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 11,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), o.get("renderer").grid.template.setAll({disabled: !0, strokeOpacity: 0});
                    ...
                    s.strokes.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), s.strokes.template.setAll({
                        ...
                        cornerRadiusBL: 0,
                        cornerRadiusTL: 6
                    }), t.set("cursor", am5xy.XYCursor.new(a, {})), t.get("cursor").lineX.setAll({visible: !1}), t.get("cursor").lineY.setAll({visible: !1}), t.children.push(am5.Legend.new(a, {
                        centerX: am5.p50,
                        x: am5.p50
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    var a = [{age: "0 to 5", male: 10175713, female: 9736305}, {
                        ...
                        male: 2378691,
                        female: 3432738
                    }, {age: "85 and Older", male: 2000771, female: 3937981}], t = {
                    ...
                    o.numberFormatter.setAll({numberFormat: "#.##as"});
                    ...
                    var n = i.yAxes.push(am5xy.CategoryAxis.new(o, {
                        categoryField: "age",
                        renderer: am5xy.AxisRendererY.new(o, {opposite: !0})
                    }));
                    ...
                    var m = i.xAxes.push(am5xy.ValueAxis.new(o, {
                        ...
                        max: 10,
                        numberFormat: "#.s'%'",
                        renderer: am5xy.AxisRendererX.new(o, {minGridDistance: 40})
                    }));
                    m.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 11,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), m.get("renderer").grid.template.setAll({disabled: !0, strokeOpacity: 0});
        ...
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    }), l.grid.template.setAll({location: .5, strokeDasharray: [2, 2]});
                    var o = t.xAxes.push(am5xy.CategoryAxis.new(a, {
                            maxDeviation: 0,
                            categoryField: "name",
                            renderer: l
                        })), r = am5radar.AxisRendererRadial.new(a, {minGridDistance: 30}),
                        i = t.yAxes.push(am5xy.ValueAxis.new(a, {renderer: r}));
                    r.grid.template.setAll({strokeDasharray: [2, 2]});
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-primary"), r = KTUtil.getCssVariableValue("--bs-primary"),
                    i = e.getAttribute("data-kt-chart-info"), s = new ApexCharts(e, {
                        series: [{
                            name: i,
        ...
        !function () {
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                    t = KTUtil.getCssVariableValue("--bs-border-dashed-color"), l = new ApexCharts(e, {
                        ...
                        dataLabels: {
                            enabled: !0, textAnchor: "start", offsetX: 0, formatter: function (e, a) {
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-info"), r = new ApexCharts(e, {
                        series: [{
                            name: "Links",
                        ...
                        xaxis: {
                            ...
                            axisTicks: {show: !1},
                            tickAmount: 3,
                            labels: {rotate: 0, rotateAlways: !1, style: {colors: t, fontSize: "12px"}},
                            crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}},
                            tooltip: {enabled: !0, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}
                        },
                        yaxis: {
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-warning"), r = new ApexCharts(e, {
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-success"), r = KTUtil.getCssVariableValue("--bs-success"),
                    i = new ApexCharts(e, {
                        series: [{
                            name: "Sales",
...
var KTChartsWidget33 = function () {
    var e = function (e, a, t, l, o) {
        ...
        if (r) {
            var i = r.getAttribute("data-kt-chart-color"), s = parseInt(KTUtil.css(r, "height")),
                n = KTUtil.getCssVariableValue("--bs-gray-500"),
                m = KTUtil.getCssVariableValue("--bs-border-dashed-color"), d = KTUtil.getCssVariableValue("--bs-" + i),
                g = new ApexCharts(r, {
                    series: [{name: "Etherium ", data: t}],
                    ...
                    xaxis: {
                        ...
                        offsetX: 20,
                        tickAmount: 4,
                        labels: {rotate: 0, rotateAlways: !1, show: !1, style: {colors: n, fontSize: "12px"}},
                ...
                }), c = !1, f = document.querySelector(e);
...
var KTChartsWidget34 = function () {
    var e = function (e, a, t, l, o) {
        var r = document.querySelector(a);
        if (r) {
            var i = parseInt(KTUtil.css(r, "height")), s = r.getAttribute("data-kt-chart-color"),
                n = KTUtil.getCssVariableValue("--bs-gray-500"),
                m = KTUtil.getCssVariableValue("--bs-border-dashed-color"), d = KTUtil.getCssVariableValue("--bs-" + s),
                g = new ApexCharts(r, {
                    series: [{name: "Earnings", data: t}],
...
var KTChartsWidget5 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-border-dashed-color"), t = {
...
var KTChartsWidget7 = function () {
    var e = function (e) {
        ...
        if (a) {
            var t = parseInt(KTUtil.css(a, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = {
                ...
                colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")],
                grid: {borderColor: l, strokeDashArray: 4, yaxis: {lines: {show: !0}}}
            }, r = new ApexCharts(a, o), i = !1, s = document.querySelector(tabSelector);
...
var KTChartsWidget8 = function () {
    var e = function (e, a, t, l) {
        var o = document.querySelector(a);
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")), i = KTUtil.getCssVariableValue("--bs-border-dashed-color"), s = {
                series: [{name: "Social Campaigns", data: t[0]}, {
                    name: "Email Newsletter",
                    data: t[1]
                }, {name: "TV Campaign", data: t[2]}, {name: "Google Ads", data: t[3]}, {
                    name: "Courses",
                    data: t[4]
                }, {name: "Radio", data: t[5]}],
                chart: {fontFamily: "inherit", type: "bubble", height: r, toolbar: {show: !1}},
                plotOptions: {bubble: {}},
                ...
                fill: {opacity: 1},
                grid: {borderColor: i, strokeDashArray: 4, padding: {right: 20}, yaxis: {lines: {show: !0}}}
            }, n = !1, m = new ApexCharts(o, s), d = document.querySelector(e);
...
var KTChartsWidget9 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-400"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTCardsWidget1 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"), t = parseInt(KTUtil.css(e, "height")),
                    l = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.isHexColor(a) ? a : KTUtil.getCssVariableValue("--bs-" + a),
                    r = KTUtil.getCssVariableValue("--bs-gray-300"), i = new ApexCharts(e, {
                        series: [{
                            name: "Sales",
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                ...
                }, t = document.createElement("canvas"), l = document.createElement("span");
                ...
                var r = (a.size - a.lineWidth) / 2, i = function (e, a, t) {
        ...
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    l = KTUtil.getCssVariableValue("--bs-success"), o = new ApexCharts(e, {
                        series: [{
                            name: "Sales",
                        ...
                        stroke: {curve: "smooth", show: !0, width: 2, colors: [t]},
                        xaxis: {
                            axisBorder: {show: !1},
                            axisTicks: {show: !1},
                            labels: {show: !1},
                        ...
                        markers: {strokeColor: t, strokeWidth: 2}
                    });
                setTimeout((function () {
                    o.render()
                }), 300)
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")), t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-primary"), r = KTUtil.getCssVariableValue("--bs-gray-300"),
                    i = new ApexCharts(e, {
                        ...
                        xaxis: {
                            ...
                            labels: {show: !1, style: {colors: t, fontSize: "12px"}},
                            crosshairs: {show: !1}
                        },
...
var KTPlayersWidget1 = {
    init: function () {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", (function (e) {
            var a = this, t = document.querySelector('[data-kt-element="audio-track-1"]'),
    ...
    var e = function () {
        ...
        if (e) {
            var a = e.querySelector('[data-kt-element="audio-track-1"]'),
                ...
                g = e.querySelector('[data-kt-element="play-prev-button"]'), c = function (e) {
                    var a = parseInt(e % 60);
