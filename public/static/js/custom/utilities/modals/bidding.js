...
var KTModalBidding = function () {
    ...
    const o = () => {
        ...
        t.forEach((t => {
            $(t).select2({
                minimumResultsForSearch: 1 / 0, templateResult: function (t) {
                    return (t => {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_modal_bidding"), e = document.getElementById("kt_modal_bidding_form"), n = new bootstrap.Modal(t), e && ((() => {
                ...
                const n = t => {
                    console.log(t), e.querySelectorAll("[data-kt-modal-bidding-type]").forEach((e => {
